...
tab2.newDropdown("Weapons Farm", "Select Weapons!", {"Melee", "Sword", "Gun", "Blox Fruit"}, function(selectedOption)
     newDropdown:SetValue('Melee')
     newDropdown:OnChanged(function(Value)
        ChooseWeapon = Value
    end)
    task.spawn(function()
        while wait() do
